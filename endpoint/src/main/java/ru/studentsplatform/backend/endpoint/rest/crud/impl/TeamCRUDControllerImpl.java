...
import ru.studentsplatform.backend.endpoint.rest.crud.TeamCRUDController;
...
@Profiled
@RestController
@RequestMapping(TeamCRUDController.BASE_URL)
public class TeamCRUDControllerImpl implements TeamCRUDController {
	 ...
	 */
	public TeamCRUDControllerImpl(TeamMapper teamMapper,
