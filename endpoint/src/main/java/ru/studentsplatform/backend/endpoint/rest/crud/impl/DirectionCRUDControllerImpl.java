...
import ru.studentsplatform.backend.endpoint.rest.crud.DirectionCRUDController;
...
@Profiled
@RestController
@RequestMapping(DirectionCRUDController.BASE_URL)
public class DirectionCRUDControllerImpl implements DirectionCRUDController {
	 ...
	 */
	public DirectionCRUDControllerImpl(DirectionMapper mapper, DirectionService service) {
		this.mapper = mapper;
