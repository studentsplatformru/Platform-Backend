...
import ru.studentsplatform.backend.endpoint.rest.crud.ScheduleCellCRUDController;
...
@Profiled
@RestController
@RequestMapping(ScheduleCellCRUDController.BASE_URL)
public class ScheduleCellCRUDControllerImpl implements ScheduleCellCRUDController {
	 ...
	 */
	public ScheduleCellCRUDControllerImpl(ScheduleCellMapper scheduleCellMapper,
