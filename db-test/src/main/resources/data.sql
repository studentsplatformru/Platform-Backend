INSERT INTO university VALUES (1, 'я', 'Также я', 'Санкт-Петербургский государственный университет');
...
INSERT INTO user_info VALUES ('я', 'Также я', 'Гарри', null, 'pic', 'image/png', 'Поттер', 'Безбатькович','8-228-111',1);
INSERT INTO user_info VALUES ('я', 'Также я', 'Драко', null, 'pic', 'image/png', 'Малфой', 'Люциусович','8-001-200',2);
